...
interface ExtendedContract extends BaseContract {
  ...
  multicall?: (multicalldata, {gasPrice}:{gasPrice: bigint}) => ContractTransactionResponse;
  mintNft?: ([]) => ContractTransactionResponse;
  updateNftContent?: (tokenId: string, schoolDataArray: any[], {gasPrice}:{gasPrice: bigint}) => ContractTransactionResponse;
  schoolIdToTokenId?: (
