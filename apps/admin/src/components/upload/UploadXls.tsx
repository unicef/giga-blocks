  ...
  return (
    <Box sx={{ width: 1, position: 'relative' }}>
      ...
      >
        ...
        {hasFile && typeOfFile === 'excel' && <SingleFilePreview file={file} />}
      </StyledDropZone>
      <Box
        sx={{
          marginTop: 1,
      ...
      {hasFiles && typeOfFile === 'excel' && (
        <>
          ...
          <Stack direction="row" justifyContent="flex-end" spacing={1.5}>
            {onRemoveAll && typeOfFile === 'excel' && (
              <Button color="inherit" variant="outlined" size="small" onClick={onRemoveAll}>
                Remove all
              </Button>
            )}

            {onUpload && typeOfFile === 'excel' && (
