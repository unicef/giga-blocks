...
export default function ContributeDetail({ id }: Props) {
  ...
  const onContribute = (validity: boolean) => {
    ...
    mutate(payload);
    !validity
      ? enqueueSnackbar(`Contributed Data are invalidated. Please check invalidated Data Section`, {
          variant: 'success',
        })
      : enqueueSnackbar(`Contributed Data are validated. Please check validated Data Section`, {
          variant: 'success',
        });
                        ...
                        >
                          ...
                          {profile?.status != 'Pending' && (
                            <ProfileTextField
                              ...
                              label={`${
                                profile?.status === 'Validated' ? 'Validated by' : 'Invalidated By'
                              }`}
                              disabled
                            />
                          )}
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                          ...
                          <span>
                            <ProfileTextField
                              name="coverage"
                              value={
                                Object.values(profile?.contributed_data)[0] === true
                                  ? 'Yes'
                                  : Object.values(profile?.contributed_data)[0] === false
                                  ? 'No'
                                  : Object.values(profile?.contributed_data)[0] || ''
                              }
