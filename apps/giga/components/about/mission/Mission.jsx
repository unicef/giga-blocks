              ...
              <div className="mission-section">
                ...
                <div className="mission-vision__content">
                  <p className="mission-vision__text">
                    Our mission is to shine a global spotlight on schools that
                    would otherwise remain unseen and underserved. By placing
                    each school on a permissionless blockchain, we create an
                    irrefutable, long-lasting record of its existence and
                    connectivity status. This transparent data empowers
                    governments, NGOs, private-sector partners, and local
                    communities to coordinate efforts and deliver essential
                    resources where they are most needed. Through Giga Blocks,
                    we seek to elevate every student's right to information,
                    opportunity, and choice, no matter the school's location or
                    current level of connectivity.
                  </p>
                  <p className="mission-vision__text">
                    At the core of this mission is the belief that, when armed
                    with accurate information, the global community can mobilize
                    faster and invest more strategically. Each "activated"
                    school becomes a rallying point for collaboration, opening
                    up doors for innovative funding mechanisms, technology
            ...
            <div className="div2">
              <div className="vision-visual">
                <Image
                  ...
                  width={600}
                  height={300}
                  className="mission-vision__image responsive-image"
                  priority
                />
                {/* <div className="vision-visual__overlay">
                  <p>
                    Giga Blocks aims to redefine how we collectively tackle one
                    of the greatest challenges in education: the digital divide.
                  </p>
              ...
              <div
                className="quote-section quote-section--left"
              ...
              >
                ...
                <div className="quote-section__image">
                  <Image
                    ...
                    height={200}
                    style={{ objectFit: 'contain' }}
                    className="responsive-image-giga-blocks"
                  />
                </div>
              </div>
            </div>
              ...
              <div className="quote-section quote-section--left">
                <div className="quote-section__text">
                  <p>
                    ...
                    education system where technology acts as a catalyst and not
                    a roadblock to every child's pursuit of information,
              ...
              <div className="vision-section">
                ...
                <div className="mission-vision__content">
                  <p className="mission-vision__text">
                    ...
                    classroom, whether it’s in a bustling city or a remote
                    village, knowing that the internet is a guaranteed gateway
                    to learning, discovery, and personal growth. By rooting each
                    school’s record in an open, secure ledger, we remove the
                    barriers that often prevent communities from receiving the
                    connectivity support they desperately need. Over time, this
                    visibility will encourage policy reforms, foster
                    private-public partnerships, and create a virtuous cycle of
                    technological innovation that leaves no school behind.
                  </p>
                  <p className="mission-vision__text">
                     Our vision extends beyond simply providing internet access;
                    we aim to cultivate a global learning network where
                    resources, knowledge, and support flow freely. By bridging
                    the digital gap, students gain access to online libraries,
                    educational platforms, and real-time collaborations that
                    expand their horizons. In turn, local economies can flourish
                    as more connected communities become equipped to adapt,
                    innovate, and thrive in our increasingly digital world.
                    Ultimately, Giga Blocks seeks to lay the groundwork for an
                    equitable education system where technology acts as a
                    catalyst and not a roadblock to every child’s pursuit of
