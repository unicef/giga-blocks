...
const Sidebar = ({ imageHash, minted, fontColor, claim,owner,schoolName }) => {
          ...
          <div className="school-details__minted-content">
            ...
            <div>
              ...
              <div className="school-details__social-icons">
                <a href={`https://www.facebook.com/sharer/sharer.php?u=${`https://ipfs.io/ipfs/${imageHash}`}`} className="school-details__social-icon" target='_blank'>
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                ...
                <a href={`https://www.instagram.com/stories/highlights/${`https://ipfs.io/ipfs/${imageHash}`}`} className="school-details__social-icon">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                ...
                <a href= {`https://www.linkedin.com/sharing/share-offsite/?text=${encodeURIComponent(`https://ipfs.io/ipfs/${imageHash}`)}&title=${encodeURIComponent(schoolName)}&summary=Cool%20Nft%20Minted`} target='_blank' className="school-details__social-icon">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                ...
                <a href={`https://twitter.com/intent/tweet?url=https://ipfs.io/ipfs/${imageHash}`} target='_blank' className="school-details__social-icon">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
