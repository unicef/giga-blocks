          ...
          <div className="school-details__minted-content">
            ...
            <div>
              ...
              <div className="school-details__social-icons">
                ...
                <a href= {`https://www.linkedin.com/shareArticle?mini=true&url=${encodeURIComponent(`https://ipfs.io/ipfs/${imageHash}`)}&title=${encodeURIComponent(schoolName)}&summary=Cool%20Nft%20Minted`} target='_blank' className="school-details__social-icon">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
