      ...
      <Grid className="why-nft-0" fullWidth>
        <Column md={4} lg={4} sm={4} style={{ margin: '0 auto', width: '90%' }}>
          <span className="heading7">
            Why Join Giga Global <br /> developer community?
          </span>
        </Column>
        ...
        <Column md={4} lg={4} sm={4}>
          <div className="why-nft-card">
            ...
            <p className="heading2 width-90">
              Giga Global fosters a space for developers, blockchain enthusiasts,
        ...
        <Column md={4} lg={4} sm={4}>
          <div className="why-nft-card">
            ...
            <p className="heading2 width-90">
              ...
              Giga Global, ensure every student, everywhere, benefits from the
              digital age.
            </p>
          </div>
        </Column>
