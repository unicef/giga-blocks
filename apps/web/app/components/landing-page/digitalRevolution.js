    ...
    <>
      <Grid className="mp-0" fullWidth>
        ...
        >
          ...
          <h1 className="heading12" style={{width: '60%'}}>
            Together, Let’s Create a <br /> Digital Revolution
          </h1>
          <p className="heading3">
            ...
            shaping the global educational landscape. Be a driver of change, an
            advocate for connectivity, and a visionary for a better tomorrow.
          </p>
          </div>
        </Column>
        <Column md={4} lg={{ span: 16, offset: 7 }} sm={4} className="digital-revolution-img">
          <img className="landing-page__illo" src="/Group.png" alt="landing" />
          <div style={{position: 'absolute', top: '0', right: '0', width: '50%'}}>
          <Card title = {'Contribute to our school data and earn rewards.'} description={'Contribute today  →'} dark/>
          </div>
        </Column>
      </Grid>
    </>
